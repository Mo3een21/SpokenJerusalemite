...
const ImageCarousel = ({ language }) => {
  const image = [
    {
      src:  "/assets/images/ya3l.jpeg",
      title: language === 'AR' ? 'يائيل حزان، منسقة المجتمع' : 'יעל חזן, רכזת קהילה',
      description: language === 'AR' ? 'طالبة علم الأحياء الحاسوبي باللغة العبرية، حديثة العهد من القدس. في المجتمع منذ عام 2023، يؤمن بالخطوات الصغيرة وتقارب القلوب.' : 'סטודנטית לביולוגיה חישובית בעברית, ירושלמית טרייה. בקהילה משנת 2023, מאמינה בצעדים קטנים ובקירוב לבבות. ',
      link: '../women'
    },
    {
      src:  "/assets/images/yasmeen.jpeg",
      title: language === 'AR' ? 'ياسمين رشق منسقة مشروع التوظيف "بنححق أحلامنا"' : 'יאסמין רשק, רכזת פרוייקט התעסוקה ״בנחקק אחלאמנה״',
      description: language === 'AR' ?'حصل على درجة البكالوريوس في دراسات الشرق الأوسط والتعليم من الجامعة العبرية. في المجتمع من عام 2021. أنا جزء من الفريق المقدسي الناطق لأنني أريد تغيير واقع المرأة العربية في القدس، وأنا أؤمن بإمكانياتهن وسأبذل قصارى جهدي لإيصالهن إلى هناك.' : 'בוגרת תואר ראשון בלימודי מזרח תיכון וחינוך מהאוניברסיטה העברית. בקהילה משנת 2021. אני חלק מצוות ירושלמית מדוברת כי אני רוצה לשנות את המציאות של נשים ערביות בירושלים, מאמינה בפוטנציאל שלהן ואעשה הכל כדי שיגיעו לשם. ',
      link: '../women'
    },
    {
      src:  "/assets/images/eal.jpeg",
      title: language === 'AR' ? 'ياعيل، بيت هكيرم، القدس' : 'יעל, בית הכרם, ירושלים',
      description: language === 'AR' ? 'انضممت إلى المجتمع أثناء الحرب. أنا متطوع في مشروع التوظيف، تحرير وترجمة السيرة الذاتية، لكني أنوي البدء في تعلم اللغة العربية قريبًا حتى أتمكن أيضًا من المشاركة في تبادل اللغات وغيرها من الأحداث. الآن على وجه التحديد، عندما أصبح كل شيء من حولي فظيعًا للغاية، فإنه يسعدني ويسعدني أن أكون جزءًا من هذا المشروع الجميل. ولدي أيضًا إيمان كبير بالقوة الخاصة للاتصالات بين النساء، اللاتي يعرفن كيفية العثور على لغة مشتركة حتى عندما يأتين من أماكن مختلفة جدًا. أنا أستمتع حقًا بالمعارف التي يدعوني إليها العمل التطوعي وأتطلع إلى المشاركة في المزيد من الأشياء.' : 'הצטרפתי לקהילה במהלך המלחמה. אני מתנדבת בפרויקט התעסוקה בעריכת קורות חיים ובתרגום, אבל מתכוונת בקרוב להתחיל ללמוד ערבית כדי שאוכל להשתתף גם בחילופי השפות ובאירועים אחרים. דווקא עכשיו כשהכל סביב כל כך נורא, מרגש ומשמח אותי להיות חלק מהמיזם המקסים הזה. יש לי גם הרבה אמון בכוח המיוחד של קשרים בין נשים, שיודעות למצוא שפה משותפת גם כשהן מגיעות ממקומות מאד שונים. אני נהנית מאד מההיכרויות שההתנדבות מזמנת לי ומחכה להשתלב בדברים נוספים.',
      link: '../women'
    },
    {
      src: "/assets/images/sozan.jpeg",
      title: language === 'AR' ? 'سوزان صياد، المديرة المشاركة للمجتمع,القدس من جبل الزيتون' : 'סוזן סייד, מנהלת משותפת של הקהילה,ירושלמית מהר הזיתים',
      description: language === 'AR' ? 'في المجتمع منذ تأسيسه في عام 2017. نؤمن بمجتمعنا باعتباره مساحة آمنة لكل امرأة مقدسية لتكون على طبيعتها، لتنمو على المستوى الشخصي والمهني وتخلق واقعًا أفضل في المدينة.' : 'בקהילה מאז הקמתה ב- 2017.מאמינה בקהילה שלנו כמרחב בטוח לכל אישה ירושלמית להיות היא, לצמוח אישית ומקצועית וליצור מציאות טובה יותר בעיר.',
      link: '../women'
    }
  ];
            ...
            <div className="carousel-image-container" key={index}>
              ...
              <div className="carousel-overlay">
                ...
                <a href={image.link} className="carousel-button">
                  {language === 'AR' ? 'المزيد من القصص' :'עוד סיפורים'}
                </a>
              </div>
            </div>
          ))}
